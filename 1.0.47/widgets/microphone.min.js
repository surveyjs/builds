 ...
 */
function m(e,t){function o(){if(!1===t.checkForInactiveTracks)return!0;if("active"in e){if(!e.active)return!1}else if("ended"in e&&e.ended)return!1;return!0}function i(e,t){function o(e,t){function o(e,t,o){var r=Math.round(e.length*(t/o)),n=[],a=Number((e.length-1)/(r-1));n[0]=e[0];for(var d=1;d<r-1;d++){var s=d*a,c=Number(Math.floor(s)).toFixed(),u=Number(Math.ceil(s)).toFixed(),f=s-c;n[d]=i(e[c],e[u],f)}return n[r-1]=e[e.length-1],n}function i(e,t,o){return e+(t-e)*o}function r(e,t){for(var o=new Float64Array(t),i=0,r=e.length,n=0;n<r;n++){var a=e[n];o.set(a,i),i+=a.length}return o}function n(e,t,o){for(var i=o.length,r=0;r<i;r++)e.setUint8(t+r,o.charCodeAt(r))}var a=e.numberOfAudioChannels,d=e.leftBuffers.slice(0),s=e.rightBuffers.slice(0),c=e.sampleRate,u=e.internalInterleavedLength,f=e.desiredSampRate;2===a&&(d=r(d,u),s=r(s,u),f&&(d=o(d,f,c),s=o(s,f,c))),1===a&&(d=r(d,u),f&&(d=o(d,f,c))),f&&(c=f);var l;2===a&&(l=function(e,t){for(var o=e.length+t.length,i=new Float64Array(o),r=0,n=0;n<o;)i[n++]=e[r],i[n++]=t[r],r++;return i}(d,s)),1===a&&(l=d);var h=l.length,m=44+2*h,g=new ArrayBuffer(m),p=new DataView(g);n(p,0,"RIFF"),p.setUint32(4,44+2*h,!0),n(p,8,"WAVE"),n(p,12,"fmt "),p.setUint32(16,16,!0),p.setUint16(20,1,!0),p.setUint16(22,a,!0),p.setUint32(24,c,!0),p.setUint32(28,2*c,!0),p.setUint16(32,2*a,!0),p.setUint16(34,16,!0),n(p,36,"data"),p.setUint32(40,2*h,!0);for(var v=h,b=44,w=0;w<v;w++)p.setInt16(b,32767*l[w],!0),b+=2;if(t)return t({buffer:g,view:p});postMessage({buffer:g,view:p})}if(M||x||U||e.noWorker)return void o(e,function(e){t(e.buffer,e.view)});var i=r(o);i.onmessage=function(e){t(e.data.buffer,e.data.view),A.revokeObjectURL(i.workerURL),i.terminate()},i.postMessage(e)}function r(e){var t=A.createObjectURL(new Blob([e.toString(),";this.onmessage =  function (eee) {"+e.name+"(eee.data);}"],{type:"application/javascript"})),o=new Worker(t);return o.workerURL=t,o}function n(){f=[],l=[],m=0,S=!1,h=!1,T=!1,v=null,u.leftchannel=f,u.rightchannel=l,u.numberOfAudioChannels=g,u.desiredSampRate=p,u.sampleRate=R,u.recordingLength=m,k={left:[],right:[],recordingLength:0}}function a(){c&&(c.onaudioprocess=null,c.disconnect(),c=null),b&&(b.disconnect(),b=null),n()}function d(e){if(!T){if(!1===o()&&(t.disableLogs||console.log("MediaStream seems stopped."),c.disconnect(),h=!1),!h)return void(b&&(b.disconnect(),b=null));S||(S=!0,t.onAudioProcessStarted&&t.onAudioProcessStarted(),t.initCallback&&t.initCallback());var i=e.inputBuffer.getChannelData(0),r=new Float32Array(i);if(f.push(r),2===g){var n=e.inputBuffer.getChannelData(1),a=new Float32Array(n);l.push(a)}m+=y,u.recordingLength=m,void 0!==t.timeSlice&&(k.recordingLength+=y,k.left.push(r),2===g&&k.right.push(a))}}function s(){h&&"function"==typeof t.ondataavailable&&void 0!==t.timeSlice&&(k.left.length?(i({desiredSampRate:p,sampleRate:R,numberOfAudioChannels:g,internalInterleavedLength:k.recordingLength,leftBuffers:k.left,rightBuffers:1===g?[]:k.right},function(e,o){var i=new Blob([o],{type:"audio/wav"});t.ondataavailable(i),setTimeout(s,t.timeSlice)}),k={left:[],right:[],recordingLength:0}):setTimeout(s,t.timeSlice))}if(!e.getAudioTracks().length)throw"Your stream has no audio tracks.";t=t||{};var c,u=this,f=[],l=[],h=!1,m=0,g=2,p=t.desiredSampRate;!0===t.leftChannel&&(g=1),1===t.numberOfAudioChannels&&(g=1),(!g||g<1)&&(g=2),t.disableLogs||console.log("StereoAudioRecorder is set to record number of channels: ",g),void 0===t.checkForInactiveTracks&&(t.checkForInactiveTracks=!0),this.record=function(){if(!1===o())throw"Please make sure MediaStream is active.";n(),S=T=!1,h=!0,void 0!==t.timeSlice&&s()},this.stop=function(e){e=e||function(){},h=!1,i({desiredSampRate:p,sampleRate:R,numberOfAudioChannels:g,internalInterleavedLength:m,leftBuffers:f,rightBuffers:1===g?[]:l},function(t,o){u.blob=new Blob([o],{type:"audio/wav"}),u.buffer=new ArrayBuffer(o.buffer.byteLength),u.view=o,u.sampleRate=p||R,u.bufferSize=y,u.length=m,S=!1,e&&e(u.blob)})},O.AudioContextConstructor||(O.AudioContextConstructor=new O.AudioContext);var v=O.AudioContextConstructor,b=v.createMediaStreamSource(e),w=[0,256,512,1024,2048,4096,8192,16384],y=void 0===t.bufferSize?4096:t.bufferSize;if(-1===w.indexOf(y)&&(t.disableLogs||console.warn("Legal values for buffer-size are "+JSON.stringify(w,null,"\t"))),v.createJavaScriptNode)c=v.createJavaScriptNode(y,g,g);else{if(!v.createScriptProcessor)throw"WebAudio API has no support on this browser.";c=v.createScriptProcessor(y,g,g)}b.connect(c),t.bufferSize||(y=c.bufferSize);var R=void 0!==t.sampleRate?t.sampleRate:v.sampleRate||44100;(R<22050||R>96e3)&&(t.disableLogs||console.warn("sample-rate must be under range 22050 and 96000.")),t.disableLogs||(console.log("sample-rate",R),console.log("buffer-size",y),t.desiredSampRate&&console.log("Desired sample-rate",t.desiredSampRate));var T=!1;this.pause=function(){T=!0},this.resume=function(){if(!1===o())throw"Please make sure MediaStream is active.";if(!h)return t.disableLogs||console.log("Seems recording has been restarted."),void this.record();T=!1},this.clearRecordedData=function(){t.checkForInactiveTracks=!1,h&&this.stop(a),a()},this.name="StereoAudioRecorder",this.toString=function(){return this.name};var S=!1;c.onaudioprocess=d,c.connect(v.destination),this.leftchannel=f,this.rightchannel=l,this.numberOfAudioChannels=g,this.desiredSampRate=p,this.sampleRate=R,u.recordingLength=m;var k={left:[],right:[],recordingLength:0}}/**
 ...
 */
function g(e,t){function o(){g.frames=[],f=!1,l=!1}function i(){var t=document.createElement("canvas"),o=t.getContext("2d");return t.width=e.width,t.height=e.height,o.drawImage(e,0,0),t}function r(){if(l)return m=(new Date).getTime(),setTimeout(r,500);if("canvas"===e.nodeName.toLowerCase()){var o=(new Date).getTime()-m;return m=(new Date).getTime(),g.frames.push({image:i(),duration:o}),void(f&&setTimeout(r,t.frameInterval))}html2canvas(e,{grabMouse:void 0===t.showMousePointer||t.showMousePointer,onrendered:function(e){var o=(new Date).getTime()-m;if(!o)return setTimeout(r,t.frameInterval);m=(new Date).getTime(),g.frames.push({image:e.toDataURL("image/webp",1),duration:o}),f&&setTimeout(r,t.frameInterval)}})}if("undefined"==typeof html2canvas)throw"Please link: https://cdn.webrtc-experiment.com/screenshot.js";t=t||{},t.frameInterval||(t.frameInterval=10);var n=!1;["captureStream","mozCaptureStream","webkitCaptureStream"].forEach(function(e){e in document.createElement("canvas")&&(n=!0)});var a=!(!window.webkitRTCPeerConnection&&!window.webkitGetUserMedia||!window.chrome),d=50,s=navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./);a&&s&&s[2]&&(d=parseInt(s[2],10)),a&&d<52&&(n=!1),t.useWhammyRecorder&&(n=!1);var c,u;if(n)if(t.disableLogs||console.log("Your browser supports both MediRecorder API and canvas.captureStream!"),e instanceof HTMLCanvasElement)c=e;else{if(!(e instanceof CanvasRenderingContext2D))throw"Please pass either HTMLCanvasElement or CanvasRenderingContext2D.";c=e.canvas}else navigator.mozGetUserMedia&&(t.disableLogs||console.error("Canvas recording is NOT supported in Firefox."));var f;this.record=function(){if(f=!0,n&&!t.useWhammyRecorder){var e;"captureStream"in c?e=c.captureStream(25):"mozCaptureStream"in c?e=c.mozCaptureStream(25):"webkitCaptureStream"in c&&(e=c.webkitCaptureStream(25));try{var o=new B;o.addTrack(e.getVideoTracks()[0]),e=o}catch(e){}if(!e)throw"captureStream API are NOT available.";u=new h(e,{mimeType:"video/webm"}),u.record()}else g.frames=[],m=(new Date).getTime(),r();t.initCallback&&t.initCallback()},this.getWebPImages=function(o){if("canvas"!==e.nodeName.toLowerCase())return void o();var i=g.frames.length;g.frames.forEach(function(e,o){var r=i-o;t.disableLogs||console.log(r+"/"+i+" frames remaining"),t.onEncodingCallback&&t.onEncodingCallback(r,i);var n=e.image.toDataURL("image/webp",1);g.frames[o].image=n}),t.disableLogs||console.log("Generating WebM"),o()},this.stop=function(e){f=!1;var o=this;if(n&&u)return void u.stop(e);this.getWebPImages(function(){g.compile(function(i){t.disableLogs||console.log("Recording finished!"),o.blob=i,o.blob.forEach&&(o.blob=new Blob([],{type:"video/webm"})),e&&e(o.blob),g.frames=[]})})};var l=!1;this.pause=function(){if(l=!0,u instanceof h)return void u.pause()},this.resume=function(){if(l=!1,u instanceof h)return void u.resume();f||this.record()},this.clearRecordedData=function(){f&&this.stop(o),o()},this.name="CanvasRecorder",this.toString=function(){return this.name};var m=(new Date).getTime(),g=new E.Video(100)}/**
 ...
 * @see {@link https://github.com/muaz-khan/RecordRTC|RecordRTC Source Code}
 */
var O={};void 0!==L?O.AudioContext=L:"undefined"!=typeof webkitAudioContext&&(O.AudioContext=webkitAudioContext),void 0!==r&&(r.Storage=O),void 0!==r&&(r.MediaStreamRecorder=h),void 0!==r&&(r.StereoAudioRecorder=m),void 0!==r&&(r.CanvasRecorder=g),void 0!==r&&(r.WhammyRecorder=p);/**
