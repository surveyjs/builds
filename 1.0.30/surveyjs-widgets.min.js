 ...
 */
function o(e,t){function i(i){return i&&(t=new a(e,i)),t.disableLogs||console.log("started recording "+t.type+" stream."),v?(v.clearRecordedData(),v.record(),g("recording"),b.recordingDuration&&p(),b):(n(function(){b.recordingDuration&&p()}),b)}function n(i){i&&(t.initCallback=function(){i(),i=t.initCallback=null});var n=new r(e,t);v=new n(e,t),v.record(),g("recording"),t.disableLogs||console.log("Initialized recorderType:",v.constructor.name,"for output-type:",t.type)}function d(e){function i(i){if(!v)return void("function"==typeof e.call?e.call(b,""):e(""));Object.keys(v).forEach(function(e){"function"!=typeof v[e]&&(b[e]=v[e])});var n=v.blob;if(!n){if(!i)throw"Recording failed.";v.blob=n=i}if(n&&!t.disableLogs&&console.log(n.type,"->",s(n.size)),e){var o=O.createObjectURL(n);"function"==typeof e.call?e.call(b,o):e(o)}t.autoWriteToDisk&&m(function(e){var i={};i[t.type+"Blob"]=e,I.Store(i)})}return e=e||function(){},v?"paused"===b.state?(b.resumeRecording(),void setTimeout(function(){d(e)},1)):("recording"===b.state||t.disableLogs||console.warn('Recording state should be: "recording", however current state is: ',b.state),t.disableLogs||console.log("Stopped recording "+t.type+" stream."),"gif"!==t.type?v.stop(i):(v.stop(),i()),void g("stopped")):void h()}function u(){return v?"recording"!==b.state?void(t.disableLogs||console.warn("Unable to pause the recording. Recording state: ",b.state)):(g("paused"),v.pause(),void(t.disableLogs||console.log("Paused recording."))):void h()}function l(){return v?"paused"!==b.state?void(t.disableLogs||console.warn("Unable to resume the recording. Recording state: ",b.state)):(g("recording"),v.resume(),void(t.disableLogs||console.log("Resumed recording."))):void h()}function f(e){postMessage((new FileReaderSync).readAsDataURL(e))}function m(e,i){if(!e)throw"Pass a callback function over getDataURL.";var n=i?i.blob:(v||{}).blob;if(!n)return t.disableLogs||console.warn("Blob encoder did not finish its job yet."),void setTimeout(function(){m(e,i)},1e3);if("undefined"==typeof Worker||navigator.mozGetUserMedia){var o=new FileReader;o.readAsDataURL(n),o.onload=function(t){e(t.target.result)}}else{var a=function(e){var t=O.createObjectURL(new Blob([e.toString(),"this.onmessage =  function (e) {"+e.name+"(e.data);}"],{type:"application/javascript"})),i=new Worker(t);return O.revokeObjectURL(t),i}(f);a.onmessage=function(t){e(t.data)},a.postMessage(n)}}function p(e){if(e=e||0,"paused"===b.state)return void setTimeout(function(){p(e)},1e3);if("stopped"!==b.state){if(e>=b.recordingDuration)return void d(b.onRecordingStopped);e+=1e3,setTimeout(function(){p(e)},1e3)}}function g(e){b&&(b.state=e,"function"==typeof b.onStateChanged.call?b.onStateChanged.call(b,e):b.onStateChanged(e))}function h(){!0!==t.disableLogs&&console.warn(y)}if(!e)throw"First parameter is required.";t=t||{type:"video"},t=new a(e,t);var v,b=this,y='It seems that recorder is destroyed or "startRecording" is not invoked for '+t.type+" recorder.",w={startRecording:i,stopRecording:d,pauseRecording:u,resumeRecording:l,initRecorder:n,setRecordingDuration:function(e,t){if(void 0===e)throw"recordingDuration is required.";if("number"!=typeof e)throw"recordingDuration must be a number.";return b.recordingDuration=e,b.onRecordingStopped=t||function(){},{onRecordingStopped:function(e){b.onRecordingStopped=e}}},clearRecordedData:function(){if(!v)return void h();v.clearRecordedData(),t.disableLogs||console.log("Cleared old recorded data.")},getBlob:function(){return v?v.blob:void h()},getDataURL:m,toURL:function(){return v?O.createObjectURL(v.blob):void h()},getInternalRecorder:function(){return v},save:function(e){if(!v)return void h();c(v.blob,e)},getFromDisk:function(e){if(!v)return void h();o.getFromDisk(t.type,e)},setAdvertisementArray:function(e){t.advertisement=[];for(var i=e.length,n=0;n<i;n++)t.advertisement.push({duration:n,image:e[n]})},blob:null,bufferSize:0,sampleRate:0,buffer:null,reset:function(){v&&"function"==typeof v.clearRecordedData&&v.clearRecordedData(),v=null,g("inactive"),b.blob=null},onStateChanged:function(e){t.disableLogs||console.log("Recorder state changed:",e)},state:"inactive",getState:function(){return b.state},destroy:function(){var e=t.disableLogs;t.disableLogs=!0,b.reset(),t={},g("destroyed"),w=b=null,j.AudioContextConstructor&&(j.AudioContextConstructor.close(),j.AudioContextConstructor=null),e||console.warn("RecordRTC is destroyed.")},version:"5.4.6"};if(!this)return b=w,w;for(var C in w)this[C]=w[C];return b=this,w}/**
 ...
 */
function p(e,t){function i(){if(!1===t.checkForInactiveTracks)return!0;if("active"in e){if(!e.active)return!1}else if("ended"in e&&e.ended)return!1;return!0}function n(e,t){function i(e,t){function i(e,t,i){var o=Math.round(e.length*(t/i)),a=[],r=Number((e.length-1)/(o-1));a[0]=e[0];for(var d=1;d<o-1;d++){var s=d*r,c=Number(Math.floor(s)).toFixed(),u=Number(Math.ceil(s)).toFixed(),l=s-c;a[d]=n(e[c],e[u],l)}return a[o-1]=e[e.length-1],a}function n(e,t,i){return e+(t-e)*i}function o(e,t){for(var i=new Float64Array(t),n=0,o=e.length,a=0;a<o;a++){var r=e[a];i.set(r,n),n+=r.length}return i}function a(e,t,i){for(var n=i.length,o=0;o<n;o++)e.setUint8(t+o,i.charCodeAt(o))}var r=e.numberOfAudioChannels,d=e.leftBuffers.slice(0),s=e.rightBuffers.slice(0),c=e.sampleRate,u=e.internalInterleavedLength,l=e.desiredSampRate;2===r&&(d=o(d,u),s=o(s,u),l&&(d=i(d,l,c),s=i(s,l,c))),1===r&&(d=o(d,u),l&&(d=i(d,l,c))),l&&(c=l);var f;2===r&&(f=function(e,t){for(var i=e.length+t.length,n=new Float64Array(i),o=0,a=0;a<i;)n[a++]=e[o],n[a++]=t[o],o++;return n}(d,s)),1===r&&(f=d);var m=f.length,p=44+2*m,g=new ArrayBuffer(p),h=new DataView(g);a(h,0,"RIFF"),h.setUint32(4,44+2*m,!0),a(h,8,"WAVE"),a(h,12,"fmt "),h.setUint32(16,16,!0),h.setUint16(20,1,!0),h.setUint16(22,r,!0),h.setUint32(24,c,!0),h.setUint32(28,2*c,!0),h.setUint16(32,2*r,!0),h.setUint16(34,16,!0),a(h,36,"data"),h.setUint32(40,2*m,!0);for(var v=m,b=44,y=0;y<v;y++)h.setInt16(b,32767*f[y],!0),b+=2;if(t)return t({buffer:g,view:h});postMessage({buffer:g,view:h})}if(M||D||L||e.noWorker)return void i(e,function(e){t(e.buffer,e.view)});var n=o(i);n.onmessage=function(e){t(e.data.buffer,e.data.view),O.revokeObjectURL(n.workerURL)},n.postMessage(e)}function o(e){var t=O.createObjectURL(new Blob([e.toString(),";this.onmessage =  function (e) {"+e.name+"(e.data);}"],{type:"application/javascript"})),i=new Worker(t);return i.workerURL=t,i}function a(){l=[],f=[],p=0,k=!1,m=!1,R=!1,v=null,u.leftchannel=l,u.rightchannel=f,u.numberOfAudioChannels=g,u.desiredSampRate=h,u.sampleRate=C,u.recordingLength=p,T={left:[],right:[],recordingLength:0}}function r(){c&&(c.onaudioprocess=null,c.disconnect(),c=null),b&&(b.disconnect(),b=null),a()}function d(e){if(!R){if(!1===i()&&(t.disableLogs||console.log("MediaStream seems stopped."),c.disconnect(),m=!1),!m)return void(b&&(b.disconnect(),b=null));k||(k=!0,t.onAudioProcessStarted&&t.onAudioProcessStarted(),t.initCallback&&t.initCallback());var n=e.inputBuffer.getChannelData(0),o=new Float32Array(n);if(l.push(o),2===g){var a=e.inputBuffer.getChannelData(1),r=new Float32Array(a);f.push(r)}p+=w,u.recordingLength=p,void 0!==t.timeSlice&&(T.recordingLength+=w,T.left.push(o),2===g&&T.right.push(r))}}function s(){m&&"function"==typeof t.ondataavailable&&void 0!==t.timeSlice&&(T.left.length?(n({desiredSampRate:h,sampleRate:C,numberOfAudioChannels:g,internalInterleavedLength:T.recordingLength,leftBuffers:T.left,rightBuffers:1===g?[]:T.right},function(e,i){var n=new Blob([i],{type:"audio/wav"});t.ondataavailable(n),setTimeout(s,t.timeSlice)}),T={left:[],right:[],recordingLength:0}):setTimeout(s,t.timeSlice))}if(!e.getAudioTracks().length)throw"Your stream has no audio tracks.";t=t||{};var c,u=this,l=[],f=[],m=!1,p=0,g=2,h=t.desiredSampRate;!0===t.leftChannel&&(g=1),1===t.numberOfAudioChannels&&(g=1),(!g||g<1)&&(g=2),t.disableLogs||console.log("StereoAudioRecorder is set to record number of channels: ",g),void 0===t.checkForInactiveTracks&&(t.checkForInactiveTracks=!0),this.record=function(){if(!1===i())throw"Please make sure MediaStream is active.";a(),k=R=!1,m=!0,void 0!==t.timeSlice&&s()},this.stop=function(e){e=e||function(){},m=!1,n({desiredSampRate:h,sampleRate:C,numberOfAudioChannels:g,internalInterleavedLength:p,leftBuffers:l,rightBuffers:1===g?[]:f},function(t,i){u.blob=new Blob([i],{type:"audio/wav"}),u.buffer=new ArrayBuffer(i.buffer.byteLength),u.view=i,u.sampleRate=h||C,u.bufferSize=w,u.length=p,k=!1,e&&e(u.blob)})},j.AudioContextConstructor||(j.AudioContextConstructor=new j.AudioContext);var v=j.AudioContextConstructor,b=v.createMediaStreamSource(e),y=[0,256,512,1024,2048,4096,8192,16384],w=void 0===t.bufferSize?4096:t.bufferSize;if(-1===y.indexOf(w)&&(t.disableLogs||console.warn("Legal values for buffer-size are "+JSON.stringify(y,null,"\t"))),v.createJavaScriptNode)c=v.createJavaScriptNode(w,g,g);else{if(!v.createScriptProcessor)throw"WebAudio API has no support on this browser.";c=v.createScriptProcessor(w,g,g)}b.connect(c),t.bufferSize||(w=c.bufferSize);var C=void 0!==t.sampleRate?t.sampleRate:v.sampleRate||44100;(C<22050||C>96e3)&&(t.disableLogs||console.warn("sample-rate must be under range 22050 and 96000.")),t.disableLogs||(console.log("sample-rate",C),console.log("buffer-size",w),t.desiredSampRate&&console.log("Desired sample-rate",t.desiredSampRate));var R=!1;this.pause=function(){R=!0},this.resume=function(){if(!1===i())throw"Please make sure MediaStream is active.";if(!m)return t.disableLogs||console.log("Seems recording has been restarted."),void this.record();R=!1},this.clearRecordedData=function(){t.checkForInactiveTracks=!1,m&&this.stop(r),r()},this.name="StereoAudioRecorder",this.toString=function(){return this.name};var k=!1;c.onaudioprocess=d,c.connect(v.destination),this.leftchannel=l,this.rightchannel=f,this.numberOfAudioChannels=g,this.desiredSampRate=h,this.sampleRate=C,u.recordingLength=p;var T={left:[],right:[],recordingLength:0}}/**
 ...
 */
function g(e,t){function i(){g.frames=[],l=!1,f=!1}function n(){var t=document.createElement("canvas"),i=t.getContext("2d");return t.width=e.width,t.height=e.height,i.drawImage(e,0,0),t}function o(){if(f)return p=(new Date).getTime(),setTimeout(o,500);if("canvas"===e.nodeName.toLowerCase()){var i=(new Date).getTime()-p;return p=(new Date).getTime(),g.frames.push({image:n(),duration:i}),void(l&&setTimeout(o,t.frameInterval))}html2canvas(e,{grabMouse:void 0===t.showMousePointer||t.showMousePointer,onrendered:function(e){var i=(new Date).getTime()-p;if(!i)return setTimeout(o,t.frameInterval);p=(new Date).getTime(),g.frames.push({image:e.toDataURL("image/webp",1),duration:i}),l&&setTimeout(o,t.frameInterval)}})}if("undefined"==typeof html2canvas)throw"Please link: https://cdn.webrtc-experiment.com/screenshot.js";t=t||{},t.frameInterval||(t.frameInterval=10);var a=!1;["captureStream","mozCaptureStream","webkitCaptureStream"].forEach(function(e){e in document.createElement("canvas")&&(a=!0)});var r=!(!window.webkitRTCPeerConnection&&!window.webkitGetUserMedia||!window.chrome),d=50,s=navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./);r&&s&&s[2]&&(d=parseInt(s[2],10)),r&&d<52&&(a=!1);var c,u;if(a)if(t.disableLogs||console.log("Your browser supports both MediRecorder API and canvas.captureStream!"),e instanceof HTMLCanvasElement)c=e;else{if(!(e instanceof CanvasRenderingContext2D))throw"Please pass either HTMLCanvasElement or CanvasRenderingContext2D.";c=e.canvas}else navigator.mozGetUserMedia&&(t.disableLogs||console.error("Canvas recording is NOT supported in Firefox."));var l;this.record=function(){if(l=!0,a&&!t.useWhammyRecorder){var e;"captureStream"in c?e=c.captureStream(25):"mozCaptureStream"in c?e=c.mozCaptureStream(25):"webkitCaptureStream"in c&&(e=c.webkitCaptureStream(25));try{var i=new U;i.addTrack(e.getVideoTracks()[0]),e=i}catch(e){}if(!e)throw"captureStream API are NOT available.";u=new m(e,{mimeType:"video/webm"}),u.record()}else g.frames=[],p=(new Date).getTime(),o();t.initCallback&&t.initCallback()},this.getWebPImages=function(i){if("canvas"!==e.nodeName.toLowerCase())return void i();var n=g.frames.length;g.frames.forEach(function(e,i){var o=n-i;t.disableLogs||console.log(o+"/"+n+" frames remaining"),t.onEncodingCallback&&t.onEncodingCallback(o,n);var a=e.image.toDataURL("image/webp",1);g.frames[i].image=a}),t.disableLogs||console.log("Generating WebM"),i()},this.stop=function(e){l=!1;var i=this;if(a&&u)return void u.stop(e);this.getWebPImages(function(){g.compile(function(n){t.disableLogs||console.log("Recording finished!"),i.blob=n,i.blob.forEach&&(i.blob=new Blob([],{type:"video/webm"})),e&&e(i.blob),g.frames=[]})})};var f=!1;this.pause=function(){if(f=!0,u instanceof m)return void u.pause()},this.resume=function(){if(f=!1,u instanceof m)return void u.resume();l||this.record()},this.clearRecordedData=function(){l&&this.stop(i),i()},this.name="CanvasRecorder",this.toString=function(){return this.name};var p=(new Date).getTime(),g=new B.Video(100)}/**
 ...
 * @see {@link https://github.com/muaz-khan/RecordRTC|RecordRTC Source Code}
 */
var j={};void 0!==x?j.AudioContext=x:"undefined"!=typeof webkitAudioContext&&(j.AudioContext=webkitAudioContext),void 0!==o&&(o.Storage=j),void 0!==o&&(o.MediaStreamRecorder=m),void 0!==o&&(o.StereoAudioRecorder=p),void 0!==o&&(o.CanvasRecorder=g),void 0!==o&&(o.WhammyRecorder=h);/**
