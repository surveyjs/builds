 ...
 */
function v(e,t){function n(){if(!1===t.checkForInactiveTracks)return!0;if("active"in e){if(!e.active)return!1}else if("ended"in e&&e.ended)return!1;return!0}function i(e,t){function n(e,t){function n(e,t,n){var o=Math.round(e.length*(t/n)),a=[],r=Number((e.length-1)/(o-1));a[0]=e[0];for(var d=1;d<o-1;d++){var s=d*r,c=Number(Math.floor(s)).toFixed(),u=Number(Math.ceil(s)).toFixed(),l=s-c;a[d]=i(e[c],e[u],l)}return a[o-1]=e[e.length-1],a}function i(e,t,n){return e+(t-e)*n}function o(e,t){for(var n=new Float64Array(t),i=0,o=e.length,a=0;a<o;a++){var r=e[a];n.set(r,i),i+=r.length}return n}function a(e,t,n){for(var i=n.length,o=0;o<i;o++)e.setUint8(t+o,n.charCodeAt(o))}var r=e.numberOfAudioChannels,d=e.leftBuffers.slice(0),s=e.rightBuffers.slice(0),c=e.sampleRate,u=e.internalInterleavedLength,l=e.desiredSampRate;2===r&&(d=o(d,u),s=o(s,u),l&&(d=n(d,l,c),s=n(s,l,c))),1===r&&(d=o(d,u),l&&(d=n(d,l,c))),l&&(c=l);var f;2===r&&(f=function(e,t){for(var n=e.length+t.length,i=new Float64Array(n),o=0,a=0;a<n;)i[a++]=e[o],i[a++]=t[o],o++;return i}(d,s)),1===r&&(f=d);var m=f.length,p=44+2*m,h=new ArrayBuffer(p),v=new DataView(h);a(v,0,"RIFF"),v.setUint32(4,36+2*m,!0),a(v,8,"WAVE"),a(v,12,"fmt "),v.setUint32(16,16,!0),v.setUint16(20,1,!0),v.setUint16(22,r,!0),v.setUint32(24,c,!0),v.setUint32(28,2*c,!0),v.setUint16(32,2*r,!0),v.setUint16(34,16,!0),a(v,36,"data"),v.setUint32(40,2*m,!0);for(var g=m,b=44,y=0;y<g;y++)v.setInt16(b,32767*f[y],!0),b+=2;if(t)return t({buffer:h,view:v});postMessage({buffer:h,view:v})}if(e.noWorker)return void n(e,function(e){t(e.buffer,e.view)});var i=a(n);i.onmessage=function(e){t(e.data.buffer,e.data.view),M.revokeObjectURL(i.workerURL),i.terminate()},i.postMessage(e)}function a(e){var t=M.createObjectURL(new Blob([e.toString(),";this.onmessage =  function (eee) {"+e.name+"(eee.data);}"],{type:"application/javascript"})),n=new Worker(t);return n.workerURL=t,n}function r(){m=[],p=[],v=0,T=!1,h=!1,S=!1,y=null,f.leftchannel=m,f.rightchannel=p,f.numberOfAudioChannels=g,f.desiredSampRate=b,f.sampleRate=k,f.recordingLength=v,x={left:[],right:[],recordingLength:0}}function d(){u&&(u.onaudioprocess=null,u.disconnect(),u=null),w&&(w.disconnect(),w=null),r()}function s(e){if(!S){if(!1===n()&&(t.disableLogs||console.log("MediaStream seems stopped."),u.disconnect(),h=!1),!h)return void(w&&(w.disconnect(),w=null));T||(T=!0,t.onAudioProcessStarted&&t.onAudioProcessStarted(),t.initCallback&&t.initCallback());var i=e.inputBuffer.getChannelData(0),o=new Float32Array(i);if(m.push(o),2===g){var a=e.inputBuffer.getChannelData(1),r=new Float32Array(a);p.push(r)}v+=R,f.recordingLength=v,void 0!==t.timeSlice&&(x.recordingLength+=R,x.left.push(o),2===g&&x.right.push(r))}}function c(){h&&"function"==typeof t.ondataavailable&&void 0!==t.timeSlice&&(x.left.length?(i({desiredSampRate:b,sampleRate:k,numberOfAudioChannels:g,internalInterleavedLength:x.recordingLength,leftBuffers:x.left,rightBuffers:1===g?[]:x.right},function(e,n){var i=new Blob([n],{type:"audio/wav"});t.ondataavailable(i),setTimeout(c,t.timeSlice)}),x={left:[],right:[],recordingLength:0}):setTimeout(c,t.timeSlice))}if(!l(e,"audio").length)throw"Your stream has no audio tracks.";t=t||{};var u,f=this,m=[],p=[],h=!1,v=0,g=2,b=t.desiredSampRate;!0===t.leftChannel&&(g=1),1===t.numberOfAudioChannels&&(g=1),(!g||g<1)&&(g=2),t.disableLogs||console.log("StereoAudioRecorder is set to record number of channels: "+g),void 0===t.checkForInactiveTracks&&(t.checkForInactiveTracks=!0),this.record=function(){if(!1===n())throw"Please make sure MediaStream is active.";r(),T=S=!1,h=!0,void 0!==t.timeSlice&&c()},this.stop=function(e){e=e||function(){},h=!1,i({desiredSampRate:b,sampleRate:k,numberOfAudioChannels:g,internalInterleavedLength:v,leftBuffers:m,rightBuffers:1===g?[]:p,noWorker:t.noWorker},function(t,n){f.blob=new Blob([n],{type:"audio/wav"}),f.buffer=new ArrayBuffer(n.buffer.byteLength),f.view=n,f.sampleRate=b||k,f.bufferSize=R,f.length=v,T=!1,e&&e(f.blob)})},void 0===o.Storage&&(o.Storage={AudioContextConstructor:null,AudioContext:window.AudioContext||window.webkitAudioContext}),o.Storage.AudioContextConstructor&&"closed"!==o.Storage.AudioContextConstructor.state||(o.Storage.AudioContextConstructor=new o.Storage.AudioContext);var y=o.Storage.AudioContextConstructor,w=y.createMediaStreamSource(e),C=[0,256,512,1024,2048,4096,8192,16384],R=void 0===t.bufferSize?4096:t.bufferSize;if(-1===C.indexOf(R)&&(t.disableLogs||console.log("Legal values for buffer-size are "+JSON.stringify(C,null,"\t"))),y.createJavaScriptNode)u=y.createJavaScriptNode(R,g,g);else{if(!y.createScriptProcessor)throw"WebAudio API has no support on this browser.";u=y.createScriptProcessor(R,g,g)}w.connect(u),t.bufferSize||(R=u.bufferSize);var k=void 0!==t.sampleRate?t.sampleRate:y.sampleRate||44100;(k<22050||k>96e3)&&(t.disableLogs||console.log("sample-rate must be under range 22050 and 96000.")),t.disableLogs||t.desiredSampRate&&console.log("Desired sample-rate: "+t.desiredSampRate);var S=!1;this.pause=function(){S=!0},this.resume=function(){if(!1===n())throw"Please make sure MediaStream is active.";if(!h)return t.disableLogs||console.log("Seems recording has been restarted."),void this.record();S=!1},this.clearRecordedData=function(){t.checkForInactiveTracks=!1,h&&this.stop(d),d()},this.name="StereoAudioRecorder",this.toString=function(){return this.name};var T=!1;u.onaudioprocess=s,y.createMediaStreamDestination?u.connect(y.createMediaStreamDestination()):u.connect(y.destination),this.leftchannel=m,this.rightchannel=p,this.numberOfAudioChannels=g,this.desiredSampRate=b,this.sampleRate=k,f.recordingLength=v;var x={left:[],right:[],recordingLength:0}}/**
